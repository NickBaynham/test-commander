...
- [x] 12.2 — Provider abstraction + docker-compose provider + stubs
- [x] 12.3 — The six `/tc:sandbox-*` commands
- [x] 12.4 — GitHub Actions workflows + safety guards
- [x] 12.5 — Documentation pass (sandbox docs)
- [x] 12.6 — Testing finalization (CI dry-run with mocked provider + cap bump 11 → 12)
