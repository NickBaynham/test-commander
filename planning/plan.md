...
- [x] 9.2 — `/tc:visualize` + the shared render engine + `/tc:diagram-flow`
- [x] 9.3 — Structural diagrams (`/tc:diagram-sequence`, `/tc:diagram-state`, `/tc:diagram-architecture`)
- [x] 9.4 — Quality diagrams (`/tc:diagram-risk`, `/tc:diagram-coverage`, `/tc:diagram-traceability`, `/tc:diagram-test-strategy`)
- [x] 9.5 — `/tc:generate-infographic`
- [x] 9.6 — `/tc:render-visuals` (Mermaid CLI → SVG/PNG; refused under pytest)
- [x] 9.7 — Documentation pass (`visuals.md`, references, customization)
- [x] 9.8 — Testing finalization (cap bump 8 → 9 + integration smoke)
