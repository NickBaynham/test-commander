...
- [ ] **5.3** — `/tc:review-bdd` (TDD) + shared `review_features()` + wire generate-bdd's auto-run (`--no-review`) + `bdd-quality-review.md`; six-category universal rubric; `[bdd-review]` gap signals with the Phase-2 dedup contract
