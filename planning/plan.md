...
- [x] 11.2 — Runtime API expansion (through the 10.5 pipeline)
- [x] 11.3 — MCP server + tool definitions
- [x] 11.4 — Permission gates (server-side enforcement, unit-tested)
- [x] 11.5 — Documentation pass (`runtime-api.md`, `mcp-server.md`, `integrating.md`)
- [x] 11.6 — Testing finalization (contract + MCP round-trip + cap bump 10.5 → 11)
