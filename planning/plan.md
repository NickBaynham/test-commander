...
- [x] 13.2 — `/tc:watch-changes` + `/tc:impact-analysis`
- [x] 13.3 — `/tc:coverage-gap-analysis`
- [x] 13.4 — `/tc:propose-tests` + `/tc:create-test-pr`
- [x] 13.5 — `/tc:continuous-quality-check` + the five autonomy-mode gates
- [x] 13.6 — The continuous-quality CI workflow
- [x] 13.7 — Documentation pass (continuous-quality docs)
- [x] 13.8 — Testing finalization (PR simulation + cap bump 12 → 13)
