...
# Bumped as phases land. Through Phase 10 — tc-core (Phase 1), tc-requirements
...
# skill (tc-visualize), and the Phase 10 web console (tc-web) are all shipped.
DEFAULT_PHASE_CAP: float = 10
