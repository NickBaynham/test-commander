...
After `make install`, open Claude Code. The `test-commander:tc-core`, `test-commander:tc-requirements`, `test-commander:tc-knowledge`, `test-commander:tc-explore`, `test-commander:tc-bdd`, `test-commander:tc-traceability`, `test-commander:tc-build-framework`, `test-commander:tc-automation-plan`, `test-commander:tc-automate`, `test-commander:tc-test-data`, `test-commander:tc-run`, `test-commander:tc-quality-report`, `test-commander:tc-evidence`, `test-commander:tc-learning`, and `test-commander:tc-visualize` skills should appear in available skills. Run `/tc:init` (Phase 1) to bootstrap the workspace in your consuming project, then follow [user-guide/workflow.md](user-guide/workflow.md) for the Phase 1 walkthrough, [user-guide/reviewing-requirements.md](user-guide/reviewing-requirements.md) for the Phase 2 walkthrough, [user-guide/building-project-knowledge.md](user-guide/building-project-knowledge.md) for the Phase 3 walkthrough, [user-guide/exploring-an-app.md](user-guide/exploring-an-app.md) for the Phase 4 walkthrough, [user-guide/generating-bdd.md](user-guide/generating-bdd.md) for the Phase 5 walkthrough, [user-guide/automation.md](user-guide/automation.md) for the Phase 6 walkthrough, [user-guide/running-tests.md](user-guide/running-tests.md) for the Phase 7 walkthrough, [user-guide/learning-loop.md](user-guide/learning-loop.md) for the Phase 8 walkthrough, and [user-guide/visuals.md](user-guide/visuals.md) for the Phase 9 walkthrough.
