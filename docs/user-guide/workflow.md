...
`/tc:next` will recommend `/tc:review-requirements` when Phase 1 metadata is filled in. The five Phase 2 commands (review-requirements, review-user-stories, review-acceptance-criteria, requirements-coverage, requirements-to-tests) are shipped — follow [reviewing-requirements.md](reviewing-requirements.md) for the Phase 2 walkthrough. The five Phase 3 commands (learn-from-docs, learn-from-specs, learn-from-code, learn-from-api, learn-from-tests) are also shipped — follow [building-project-knowledge.md](building-project-knowledge.md) for the Phase 3 walkthrough. The four Phase 4 commands (create-charter, explore, session-summary, test-ideas) are also shipped — follow [exploring-an-app.md](exploring-an-app.md) for the Phase 4 walkthrough. The three Phase 5 commands (generate-bdd, review-bdd, traceability-map) are also shipped — follow [generating-bdd.md](generating-bdd.md) for the Phase 5 walkthrough. The five Phase 6 commands (build-framework, automation-plan, automate, review-automation, generate-test-data) are also shipped — follow [automation.md](automation.md) for the Phase 6 walkthrough. The four Phase 7 commands (run, analyze-results, report, quality-gate) are also shipped — follow [running-tests.md](running-tests.md) and [quality-report.md](quality-report.md) for the Phase 7 walkthroughs. The six Phase 8 commands (learn, learn-from-failures, learn-from-exploration, learn-from-feedback, review-lessons, promote-lessons) are also shipped — follow [learning-loop.md](learning-loop.md) for the Phase 8 walkthrough. For the full phased roadmap, see [../../planning/plan.md](../../planning/plan.md).
